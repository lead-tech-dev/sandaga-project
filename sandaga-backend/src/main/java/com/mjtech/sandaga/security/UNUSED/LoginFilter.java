...
import com.mjtech.sandaga.dtos.auth.SignInReqDto;
import com.mjtech.sandaga.dtos.auth.SignedInUserDto;
...
import static com.mjtech.sandaga.security.Constants.TOKEN_URL;
...
public class LoginFilter extends UsernamePasswordAuthenticationFilter {
  ...
  public Authentication attemptAuthentication(HttpServletRequest req,
    ...
    try (InputStream is = req.getInputStream()) {
      SignInReqDto user = new ObjectMapper().readValue(is, SignInReqDto.class);
  ...
  protected void successfulAuthentication(HttpServletRequest req,
    ...
    SignedInUserDto user = new SignedInUserDto().setEmail(principal.getUsername()).setAccessToken(token);
